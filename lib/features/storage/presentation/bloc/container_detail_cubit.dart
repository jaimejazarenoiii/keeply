...
class ContainerDetailCubit extends Cubit<ResourceState<StorageTreeNode>> {
  ContainerDetailCubit(this._repository) : super(const ResourceState());
    ...
    try {
      emit(
        ResourceState(
          ...
          data: await _repository.getContainerTree(id),
        ),
      );
