...
class ContainerFormPage extends StatelessWidget {
  const ContainerFormPage({super.key, required this.parentId});
      ...
      body: BlocListener<StorageFormCubit, StorageFormState>(
        ...
        child: Builder(
          builder: (context) => StorageNodeForm(
            ...
            onSubmit: () =>
                context.read<StorageFormCubit>().createContainer(parentId),
          ),
        ),
      ),
    ),
