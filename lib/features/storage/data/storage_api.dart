...
class StorageApi {
  ...
  Future<DashboardApiSummary> getDashboardSummary() => _client.get(
    '/dashboard',
    parser: (json) =>
        DashboardApiSummary.fromJson(json! as Map<String, dynamic>),
  );
  ...
  Future<StorageTreeNode> getSpaceTree(String id, {int? depth}) => _client.get(
    '/spaces/$id/tree',
    queryParameters: _depthQuery(depth),
  ...
  Future<StorageTreeNode> getContainerTree(String id, {int? depth}) =>
      _client.get(
        ...
        queryParameters: _depthQuery(depth),
        parser: (json) =>
            StorageTreeNode.fromJson(json! as Map<String, dynamic>),
      );
...
Map<String, dynamic>? _depthQuery(int? depth) {
  if (depth == null) return null;
  return {'depth': depth.clamp(1, 25)};
}
